// server/routes/applications.js - Complete Application Management Routes
...
// ======================
// JUNIOR DOCTOR ROUTES (APPLICANTS)
// ======================
...
// Update application (before submission or draft applications only)
router.put(
  "/:id/update",
  protect,
  requireActive,
...
// Rate completed project (applicant rating employer)
router.post(
  "/:id/rate",
  protect,
  requireActive,
...
// ======================
// SENIOR DOCTOR ROUTES (EMPLOYERS)
// ======================
...
// Update application status (employer actions)
router.put(
  "/:id/status",
  protect,
  requireActive,
...
// Accept application (hire candidate)
router.post(
  "/:id/accept",
  protect,
  requireActive,
...
// Get match analytics for a job
router.get("/analytics/:jobId", protect, canPostJobs, getMatchAnalytics);

// ======================
// SHARED ROUTES (BOTH APPLICANTS AND EMPLOYERS)
// ======================

// Get application details (role-based view)
...
// Calculate match score for specific job (junior doctors)
router.post(
...
// ======================
// PREMIUM/VERIFIED USER FEATURES
// ======================

// Priority application (moves application to top of list)
router.post(
  "/:id/priority",
  protect,
  requireVerifiedAccount,
...
// Admin application dispute resolution
router.put(
